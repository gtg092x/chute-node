...
String.prototype.build = function() {
  var type;
  type = this.options.fit ? 'fit' : 'fill';
  ...
  switch (type) {
    case 'fit':
      return "" + this + "/fit/" + this.options.width + "x" + this.options.height;
    case 'fixed width':
      return "" + this + "/w/" + this.options.width;
    case 'fixed height':
      return "" + this + "/h/" + this.options.height;
    case 'fill':
      return "" + this + "/" + this.options.width + "x" + this.options.height;
    default:
      return this;
  }
};
      ...
      switch (res.statusCode) {
        case 200:
          ...
          findContributors = function(done) {
            return request({
              url: "" + that.client.options.endpoint + "/chutes/" + (options.id || options.shortcut) + "/contributors",
              method: 'GET',
              headers: {
                'x-client_id': that.client.options.id,
                'Authorization': "OAUTH " + that.client.options.token
          ...
          findMembers = function(done) {
            return request({
              url: "" + that.client.options.endpoint + "/chutes/" + (options.id || options.shortcut) + "/members",
              method: 'GET',
              headers: {
                'x-client_id': that.client.options.id,
                'Authorization': "OAUTH " + that.client.options.token
          ...
          findParcels = function(done) {
            return request({
              url: "" + that.client.options.endpoint + "/chutes/" + (options.id || options.shortcut) + "/parcels",
              method: 'GET',
              headers: {
                'x-client_id': that.client.options.id,
                'Authorization': "OAUTH " + that.client.options.token
